...
The kit room supplies items for players to build kits. It has five inventory pages.
...
Fills all five pages and the bundled public kits with a ready-made crystal setup. Edit it afterwards like anything else.
